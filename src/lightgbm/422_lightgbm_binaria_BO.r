...
hs <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 32L, upper = 2048L),
  makeNumericParam("feature_fraction", lower = 0.7, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 10000L),
  makeIntegerParam("envios", lower = 0L, upper = 15000L),
  makeIntegerParam("max_depth", lower = 6L, upper = 20L),
